...
OUT=ROOT/'outputs/atlas/refinement-v23'
bpy.ops.object.select_all(action='SELECT')
bpy.ops.object.delete(use_global=False)
bpy.ops.import_scene.gltf(filepath=str(OUT/'waterfront-refined.glb'))
scene=bpy.context.scene
scene.name='WATERFRONT · Refined elven quarter V23'
...
scene['source']='src/atlas/waterfront-architecture.js; elven-joinery.js; architecture-kit.js; soft-furnishing.js'
scene['material_note']='Editable PBR export; browser painted-surface shader is not baked into native textures.'
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'waterfront-refined.blend'))
